    ...
    <>
      ...
      */}
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-10  rounded-md w-full max-w-md space-y-8">
          <div>
            <img
              className="mx-auto h-12 w-auto"
              src="https://cdnb.artstation.com/p/assets/images/images/009/016/453/large/luca-schmell-logo-2.jpg?1516655016"
              alt="Your Company"
            />
            ...
            <div>
              ...
              >
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                  <LockClosedIcon className="h-5 w-5 text-white-50 group-hover:text-slate-100" aria-hidden="true" />
                </span>
                Sign in
              </button>
            </div>
